...
public class JacksonUtil {
	...
	static {
		JSON_MAPPER = JsonMapper.builder()
			...
			// 空值处理
			.build();
		// JSON_MAPPER._serializationContext().getGenerator()
	}
	...
	// try {
	// return JSON_MAPPER.readValue(jsonNode.traverse(JSON_MAPPER), typeReference);
	// }
	// catch (JacksonException e) {
	...
	// JSON_MAPPER.registerSubtypes(new NamedType(clz, type));
	// }
